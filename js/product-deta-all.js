const mergedDetailList = [
  ...
  // ===== new PERFUME (6) — rating 없음 → "-" =====
  {
    ...
    category: "PERFUME",
    image: "./img/product-list/new/inscent-tamburins-limited-puppy_M-01.jpg",
    tags: { scent: "오리엔탈", mood: "자신감있는", lasting: "오래가고 진하게" },
    rating: "-",
    variants: [
  ...
  },
  {
    ...
    category: "PERFUME",
    image: "./img/product-list/new/inscent-tamburins-limited-sunshine_M-02.jpg",
    tags: { scent: "프레시", mood: "에너제틱한", lasting: "가볍고 은은하게" },
    rating: "-",
    variants: [
      { size: "50ml", price: 250000 }
  ...
  },
  {
    ...
    category: "PERFUME",
    image: "./img/product-list/new/inscent-byredo-astral-oud_M.jpg",
    tags: { scent: "오리엔탈", mood: "자신감있는", lasting: "오래가고 진하게" },
    rating: "-",
    variants: [
  ...
  },
  {
    ...
    category: "PERFUME",
    image: "./img/product-list/new/inscent-yves-saint-laurent-babycat_M-04.jpg",
    tags: { scent: "오리엔탈", mood: "자신감있는", lasting: "오래가고 진하게" },
    rating: "-",
    variants: [
  ...
  },
  {
    ...
    category: "PERFUME",
    image: "./img/product-list/new/inscent-diptyque-fleur-de-peau_M.jpg",
    tags: { scent: "기타", mood: "편안함", lasting: "가볍고 은은하게" },
    rating: "-",
    variants: [
  ...
  },
  {
    ...
    name: "르라보 오스만투스 19",
    category: "PERFUME",
    image: "./img/product-list/new/inscent-le-labo-osmanthus19_M-06.jpg",
    tags: { scent: "플로랄", mood: "로맨틱한", lasting: "가볍고 은은하게" },
    rating: "-",
    variants: [
      { size: "15ml",  price: 138000 },
  ...
  // ===== new BODY (7) — rating 없음 → "-" =====
  {
    brand: "Byredo",
    name: "바이레도 유자 트리 핸드 로션",
    category: "BODY",
    image: "./img/product-list/new/01body-byredo-yuzu-tree-hand-lotion.jpg",
    tags: { scent: "프레시", mood: "에너제틱한", lasting: "가볍고 은은하게" },
    rating: "-",
    variants: [
  ...
  },
  {
    ...
    category: "BODY",
    image: "./img/product-list/new/02body-acquadiparma-buongiorno-hand-body-lotion.jpg",
    tags: { scent: "프레시", mood: "에너제틱한", lasting: "가볍고 은은하게" },
    rating: "-",
    variants: [
  ...
  {
    brand: "Jo Malone",
    name: "조말론 라임 바질 앤 만다린 바디 앤 핸드 로션",
    category: "BODY",
    image: "./img/product-list/new/03body-jomalone-lime-basil-mandarin-body-hand-lotion.jpg",
    tags: { scent: "프레시", mood: "에너제틱한", lasting: "가볍고 은은하게" },
    rating: "-",
    variants: [
  ...
  },
  {
    ...
    category: "BODY",
    image: "./img/product-list/new/04body-diptyque-fresh-lotion-body.jpg",
    tags: { scent: "프레시", mood: "편안함", lasting: "가볍고 은은하게" },
    rating: "-",
    variants: [
  ...
  },
  {
    ...
    category: "BODY",
    image: "./img/product-list/new/05body-diptyque-fleur-de-peau-hand-body-lotion.jpg",
    tags: { scent: "기타", mood: "편안함", lasting: "가볍고 은은하게" },
    rating: "-",
    variants: [
      { size: "350ml", price: 95000 }
  ...
  },
  {
    ...
    category: "BODY",
    image: "./img/product-list/new/06body-tamburins-showery-fog.jpg",
    tags: { scent: "프레시", mood: "편안함", lasting: "가볍고 은은하게" },
    rating: "-",
    variants: [
  ...
  },
  {
    ...
    category: "BODY",
    image: "./img/product-list/new/07body-tamburins-showery-nimbus.jpg",
    tags: { scent: "프레시", mood: "에너제틱한", lasting: "가볍고 은은하게" },
    rating: "-",
    variants: [
      { size: "250ml", price: 48000 }
 ...
 // ===== new HAIR (add to mergedDetailList) =====

  {
    brand: "Diptyque",
    name: "딥티크 리미티드 에디션 퍼퓸 샴푸 포 헤어",
    category: "HAIR",
    image: "./img/product-list/new/08hair-diptyque-perfumed-shampoo-limited-195ml.jpg",
    tags: { scent: "프레시", mood: "편안함", lasting: "가볍고 은은하게" },
    rating: "-",
    variants: [
      { size: "195ml", price: 87000 } // 발매 2025/06/04
    ]
  },
  {
    brand: "Diptyque",
    ...
    category: "HAIR",
    image: "./img/product-list/new/09hair-diptyque-philosykos-hair-mist-30ml.jpg",
    tags: { scent: "우디", mood: "편안함", lasting: "가볍고 은은하게" },
    rating: "-",
    variants: [
      { size: "30ml", price: 94000 } // 발매 2025/06/03
    ]
  },
  {
    brand: "Diptyque",
    ...
    category: "HAIR",
    image: "./img/product-list/new/10hair-diptyque-ilio-limited-hair-mist-30ml.jpg",
    tags: { scent: "프레시", mood: "에너제틱한", lasting: "가볍고 은은하게" },
    rating: "-",
    variants: [
      { size: "30ml", price: 93000 } // 발매 2025/06/02
    ]
  },
  {
    brand: "Prada",
    ...
    category: "HAIR",
    image: "./img/product-list/new/11hair-prada-paradoxe-hair-mist-30ml.jpg",
    tags: { scent: "오리엔탈", mood: "자신감있는", lasting: "가볍고 은은하게" },
    rating: "-",
    variants: [
      { size: "30ml", price: 72000 } // 발매 2025/05/01
    ]
  },
  {
    brand: "Dior",
    ...
    category: "HAIR",
    image: "./img/product-list/new/12hair-dior-missdior-edp-hair-mist-30ml.jpg",
    tags: { scent: "플로랄", mood: "로맨틱한", lasting: "가볍고 은은하게" },
    rating: "-",
    variants: [
      { size: "30ml", price: 71000 } // 발매 2025/04/16
    ]
  },
// NEW - ETC (정식 태그 규칙 적용)

  {
    ...
    category: "ETC",
    image: "./img/product-list/new/etc/inscent-lelabo-petitgrain21-homefragrance_M.jpg",
    tags: { scent: "프레시", mood: "편안함", lasting: "오래가고 진하게" },
    rating: "-",
    variants: [
  ...
  },
  {
    ...
    name: "논픽션 랍상송 룸 스프레이",
    category: "ETC",
    image: "./img/product-list/new/etc/inscent-nonfiction-lapsang-song-roomspray-150_M.jpg",
    tags: { scent: "우디", mood: "편안함", lasting: "가볍고 은은하게" },
    rating: "-",
    variants: [
  ...
  },
  {
    ...
    category: "ETC",
    image: "./img/product-list/new/etc/inscent-diptyque-citronnelle-candle-190g_M.jpg",
    tags: { scent: "프레시", mood: "에너제틱한", lasting: "가볍고 은은하게" },
    rating: "-",
    variants: [
  ...
  },
  {
    ...
    category: "ETC",
    image: "./img/product-list/new/etc/inscent-aesop-murasaki-aromatique-incense_M.jpg",
    tags: { scent: "우디", mood: "신비로운", lasting: "오래가고 진하게" },
    rating: "-",
    variants: [
  ...
  },
  {
    ...
    category: "ETC",
    image: "./img/product-list/new/etc/inscent-aesop-istros-compact-roomspray-50_M.jpg",
    tags: { scent: "플로랄", mood: "로맨틱한", lasting: "가볍고 은은하게" },
    rating: "-",
    variants: [
  ...
  },
  {
    ...
    category: "ETC",
    image: "./img/product-list/new/etc/inscent-aesop-kythera-compact-roomspray-50_M.jpg",
    tags: { scent: "오리엔탈", mood: "자신감있는", lasting: "오래가고 진하게" },
    rating: "-",
    variants: [
  ...
  },
  {
    ...
    category: "ETC",
    image: "./img/product-list/new/etc/inscent-aesop-olous-compact-roomspray-50_M.jpg",
    tags: { scent: "프레시", mood: "에너제틱한", lasting: "가볍고 은은하게" },
    rating: "-",
    variants: [
