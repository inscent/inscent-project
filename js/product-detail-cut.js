...
{ Id:"2",
  ...
  detailImages:"./img/detail-image/detailpage3.jpg",
  ...
  info:`품명 : 랑방 에끌라 드 아르페쥬 EDP 전성분 : 변성알코올39C, 향료, 물, 에칠헥실메톡시신나메이트, 부틸메톡시디벤조일메탄, 에칠헥실살리실레이트, 비에이치티, 하이드록시이소헥실3-사이클로헥센카복스알데하이드, 부틸페닐메칠프로피오날, 리모넨, 시트랄, 리닐룰, 제라니올, 자색401호, 적색227호*제공된 성분은 동일 제품이라도 경우에 따라 변경 될 수 있습니다**최신 정보는 제품의 포장을 참고*용량 : 30ml /50ml/100ml제품주요사항 : 모든 피부 타입사용방법 : 맥박이 뛰는 부위에 분사하여 사용합니다.사용기한 : 개봉 후 3년제조자 : 인터퍼퓸프랑스 / 라운드뷰티월드,다현상사,아미코즈,인터코스메틱,제이에스티제조국 : 프랑스사용할 때의 주의사항 : 1. 화장품 사용 시 또는 사용 후 직사광선에 의하여 사용부위가 붉은 반점, 부어오름 또는 가려움증 등의 이상 증상이나부작용이 있는 경우 전문의 등과 상담할 것 2. 상처가 있는 부위 등에는 사용을 자제할 것 3. 보관 및 취급 시의 주의사항1) 어린이의 손이 닿지 않는 곳에 보관할 것 2) 직사광선을 피해서 보관할 것 4. 눈에 들어가지 않도록 주의하고 눈에 들어간 때에는 즉시 씻어 낼 것5.민감성 피부 보유자는 귓볼 등에 사전 패치 테스트 후 사용할 것품질보증기준 : 본 제품에 이상이 있을 경우, 공정거래위원회 고시 소비자분쟁해결기준에 의해 보상해 드립니다.`
},
{ Id:"3",
  ...
  detailImages:"./img/detail-image/detailpage4.jpg",
...
{ Id:"4",
  ...
  detailImages:"./img/detail-image/detailpage5.jpg",
...
{ Id:"5",
  ...
  detailImages:"./img/detail-image/detailpage6.jpg",
...
{ Id:"6",
  ...
  detailImages:"./img/detail-image/detailpage7.jpg",
...
{ Id:"7",
  ...
  detailImages:"./img/detail-image/detailpage8.jpg",
  tags: { scent: "프레시", mood: "에너제틱한", lasting: "가볍고 은은하게" },
  rating: 4.32,
  variants: [
...
{ Id:"8",
  ...
  detailImages:"./img/detail-image/detailpage9.jpg",
...
{ Id:"9",
  ...
  detailImages:"./img/detail-image/detailpage10.jpg",
  tags: { scent: "플로랄", mood: "편안함", lasting: "가볍고 은은하게" },
  rating: 4.16,
  variants: [
...
{ Id:"10",
  ...
  detailImages:"./img/detail-image/detailpage11.jpg",
  tags: { scent: "우디", mood: "자신감있는", lasting: "오래가고 진하게" },
  rating: 4.88,
  variants: [
...
},
{
  ...
  detailImages:"./img/detail-image/detailpage12.jpg",
...
{ Id:"12",
  ...
  detailImages:"./img/detail-image/detailpage13.jpg",
  tags: { scent: "우디", mood: "자신감있는", lasting: "오래가고 진하게" },
  rating: 4.83,
  variants: [
...
{ 
  ...
  detailImages:"./img/detail-image/detailpage14.jpg",
...
},
{
  ...
  detailImages:"./img/detail-image/detailpage15.jpg",
  tags: { scent: "오리엔탈", mood: "자신감있는", lasting: "오래가고 진하게" },
  rating: 4.77,
  variants: [
...
},
{
  ...
  detailImages:"./img/detail-image/detailpage16.jpg",
...
},
{
  ...
  detailImages:"./img/detail-image/detailpage17.jpg",
  tags: { scent: "프레시", mood: "에너제틱한", lasting: "가볍고 은은하게" },
  rating: 4.73,
  variants: [
    { size: "50ml",  price: 280000 },
...
},
{
  ...
  detailImages:"./img/detail-image/detailpage18.jpg",
...
},
{
  ...
  detailImages:"./img/detail-image/detailpage19.jpg",
...
},
{
  ...
  detailImages:"./img/detail-image/detailpage20.jpg",
...
// ===== BODY (10) =====
{
  ...
  detailImages:"./img/detail-image/detailpage21.jpg",
  tags: { scent: "기타", mood: "편안함", lasting: "가볍고 은은하게" },
  rating: 4.83,
  variants: [
...
},
{
  ...
  detailImages:"./img/detail-image/detailpage22.jpg",
  tags: { scent: "플로랄", mood: "자신감있는", lasting: "가볍고 은은하게" },
  rating: 4.76,
  variants: [
...
},
{
  ...
  detailImages:"./img/detail-image/detailpage23.jpg",
  tags: { scent: "플로랄", mood: "편안함", lasting: "가볍고 은은하게" },
  rating: 4.74,
  variants: [
...
},
{
  ...
  detailImages:"./img/detail-image/detailpage24.jpg",
  tags: { scent: "프레시", mood: "편안함", lasting: "가볍고 은은하게" },
  rating: 4.69,
  variants: [
...
},
{
  ...
  detailImages:"./img/detail-image/detailpage25.jpg",
  tags: { scent: "프레시", mood: "에너제틱한", lasting: "가볍고 은은하게" },
  rating: 4.69,
  variants: [
...
},
{
  ...
  detailImages:"./img/detail-image/detailpage26.jpg",
  tags: { scent: "기타", mood: "편안함", lasting: "가볍고 은은하게" },
  rating: 4.68,
  variants: [
...
},
{
  ...
  detailImages:"./img/detail-image/detailpage27.jpg",
  tags: { scent: "프레시", mood: "편안함", lasting: "가볍고 은은하게" },
  rating: 4.67,
  variants: [
...
},
{
  ...
  detailImages:"./img/detail-image/detailpage28.jpg",
  tags: { scent: "프레시", mood: "에너제틱한", lasting: "가볍고 은은하게" },
  rating: 4.67,
  variants: [
...
},
{
  ...
  detailImages:"./img/detail-image/detailpage29.jpg",
...
},
{
  ...
  detailImages:"./img/detail-image/detailpage30.jpg",
  tags: { scent: "플로랄", mood: "로맨틱한", lasting: "가볍고 은은하게" },
  rating: 4.63,
  variants: [
...
{ Id:"49",
  ...
  category: "PERFUME",
  image: "./img/product-list/new-detail/perfume/new1-tamburins-limited-puppy.jpg",
  detailImages: "./img/detail-image/new01.jpg",
  tags: { scent: "오리엔탈", mood: "자신감있는", lasting: "오래가고 진하게" },
  rating: "-",
  variants: [
...
{ Id:"50",
  ...
  category: "PERFUME",
  image: "./img/product-list/new-detail/perfume/new2-tamburins-limited-sunshine.jpg",
  detailImages: "./img/detail-image/new02.jpg",
  tags: { scent: "프레시", mood: "에너제틱한", lasting: "가볍고 은은하게" },
  rating: "-",
  variants: [
    { size: "50ml", price: 250000 }
...
{ Id:"51",
  ...
  category: "PERFUME",
  image: "./img/product-list/new-detail/perfume/new3-byredo-astral-oud.jpg",
  detailImages: "./img/detail-image/new03.jpg",
  tags: { scent: "오리엔탈", mood: "자신감있는", lasting: "오래가고 진하게" },
  rating: "-",
  variants: [
...
{ Id:"52",
  ...
  category: "PERFUME",
  image: "./img/product-list/new-detail/perfume/new4-yves-saint-laurent-babycat.jpg",
  detailImages: "./img/detail-image/new04.jpg",
  tags: { scent: "오리엔탈", mood: "자신감있는", lasting: "오래가고 진하게" },
  rating: "-",
  variants: [
...
{ Id:"53",
  ...
  category: "PERFUME",
  image: "./img/product-list/new-detail/perfume/new5-diptyque-fleur-de-peau.jpg",
  detailImages: "./img/detail-image/new05.jpg",
  tags: { scent: "기타", mood: "편안함", lasting: "가볍고 은은하게" },
  rating: "-",
  variants: [
...
{ Id:"54",
  ...
  name: "르라보 오스만투스 19",
  category: "PERFUME",
  image: "./img/product-list/new-detail/perfume/new6-le-labo-osmanthus19.jpg",
  detailImages: "./img/detail-image/new06.jpg",
  tags: { scent: "플로랄", mood: "로맨틱한", lasting: "가볍고 은은하게" },
  rating: "-",
  variants: [
    { size: "15ml",  price: 138000 },
...
{ Id:"55",
  ...
  category: "BODY",
  image: "./img/product-list/new-detail/body/new1-byredo-yuzu-tree-hand-lotion.jpg",
  tags: { scent: "프레시", mood: "에너제틱한", lasting: "가볍고 은은하게" },
  rating: "-",
  variants: [
...
{ Id:"58",
  ...
  category: "BODY",
  image: "./img/product-list/new-detail/body/new4-diptyque-fresh-lotion-body.jpg",
  tags: { scent: "프레시", mood: "편안함", lasting: "가볍고 은은하게" },
  rating: "-",
  variants: [
...
{ Id:"59",
  ...
  category: "BODY",
  image: "./img/product-list/new-detail/body/new5-diptyque-fleur-de-peau-hand-body-lotion.jpg",
  tags: { scent: "기타", mood: "편안함", lasting: "가볍고 은은하게" },
  rating: "-",
  variants: [
    { size: "350ml", price: 95000 }
...
{ Id:"60",
  ...
  category: "BODY",
  image: "./img/product-list/new-detail/body/new6-tamburins-showery-fog.jpg",
  tags: { scent: "프레시", mood: "편안함", lasting: "가볍고 은은하게" },
  rating: "-",
  variants: [
...
{ Id:"61",
  ...
  category: "BODY",
  image: "./img/product-list/new-detail/body/new7-tamburins-showery-nimbus.jpg",
  tags: { scent: "프레시", mood: "에너제틱한", lasting: "가볍고 은은하게" },
  rating: "-",
  variants: [
    { size: "250ml", price: 48000 }
...
{ Id:"62",
  ...
  category: "HAIR",
  image: "./img/product-list/new-detail/hair/new1-diptyque-perfumed-shampoo-limited.jpg",
  tags: { scent: "프레시", mood: "편안함", lasting: "가볍고 은은하게" },
  rating: "-",
  variants: [
...
{ Id:"63",
  ...
  category: "HAIR",
  image: "./img/product-list/new-detail/hair/new2-diptyque-philosykos-hair-mist.jpg",
  tags: { scent: "우디", mood: "편안함", lasting: "가볍고 은은하게" },
  rating: "-",
  variants: [
...
{ Id:"64",
  ...
  category: "HAIR",
  image: "./img/product-list/new-detail/hair/new3-diptyque-ilio-limited-hair-mist.jpg",
  tags: { scent: "프레시", mood: "에너제틱한", lasting: "가볍고 은은하게" },
  rating: "-",
  variants: [
...
{ Id:"65",
  ...
  category: "HAIR",
  image: "./img/product-list/new-detail/hair/new4-prada-paradoxe-hair-mist.jpg",
  tags: { scent: "오리엔탈", mood: "자신감있는", lasting: "가볍고 은은하게" },
  rating: "-",
  variants: [
    { size: "30ml", price: 72000 }
...
{ Id:"66",
  ...
  category: "HAIR",
  image: "./img/product-list/new-detail/hair/new5-dior-miss-dior-edp-hair-mist.jpg",
  tags: { scent: "플로랄", mood: "로맨틱한", lasting: "가볍고 은은하게" },
  rating: "-",
  variants: [
...
{ Id:"67",
  ...
  category: "ETC",
  image: "./img/product-list/new-detail/etc/new1-le-labo-petitgrain21-home-fragrance.jpg",
  tags: { scent: "프레시", mood: "편안함", lasting: "오래가고 진하게" },
  rating: "-",
  variants: [
...
{ Id:"68",
  ...
  name: "논픽션 랍상송 룸 스프레이",
  category: "ETC",
  image: "./img/product-list/new-detail/etc/new2-nonfiction-lapsang-song-room-spray.jpg",
  tags: { scent: "우디", mood: "편안함", lasting: "가볍고 은은하게" },
  rating: "-",
  variants: [
...
{ Id:"69",
  ...
  category: "ETC",
  image: "./img/product-list/new-detail/etc/new3-diptyque-citronnelle-candle-190g.jpg",
  tags: { scent: "프레시", mood: "에너제틱한", lasting: "가볍고 은은하게" },
  rating: "-",
  variants: [
...
{ Id:"70",
  ...
  category: "ETC",
  image: "./img/product-list/new-detail/etc/new4-aesop-murasaki-aromatique-incense.jpg",
  tags: { scent: "우디", mood: "신비로운", lasting: "오래가고 진하게" },
  rating: "-",
  variants: [
...
{ Id:"71",
  ...
  category: "ETC",
  image: "./img/product-list/new-detail/etc/new5-aesop-istros-compact-roomspray-50.jpg",
  tags: { scent: "플로랄", mood: "로맨틱한", lasting: "가볍고 은은하게" },
  rating: "-",
  variants: [
...
{ Id:"72",
  ...
  category: "ETC",
  image: "./img/product-list/new-detail/etc/new6-aesop-kythera-compact-roomspray-50.jpg",
  tags: { scent: "오리엔탈", mood: "자신감있는", lasting: "오래가고 진하게" },
  rating: "-",
  variants: [
...
{ Id:"73",
  ...
  category: "ETC",
  image: "./img/product-list/new-detail/etc/new7-aesop-olous-compact-roomspray-50.jpg",
  tags: { scent: "프레시", mood: "에너제틱한", lasting: "가볍고 은은하게" },
  rating: "-",
  variants: [
